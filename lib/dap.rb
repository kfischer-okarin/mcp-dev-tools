...
InitializeRequestArguments = Data.define(:client_i_d, :client_name, :adapter_i_d, :locale, :lines_start_at1, :columns_start_at1, :path_format, :supports_variable_type, :supports_variable_paging, :supports_run_in_terminal_request, :supports_memory_references, :supports_progress_reporting, :supports_invalidated_event, :supports_memory_event, :supports_args_can_be_interpreted_by_shell, :supports_start_debugging_request, :supports_a_n_s_i_styling)
LaunchRequestArguments = Data.define(:no_debug, :_restart)
AttachRequestArguments = Data.define(:_restart)
